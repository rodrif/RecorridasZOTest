...
/*
	...
	/*
	 * public void testCrearOpciones() {// TODO: arreglar Persona p =
	 * PersonaTest.crearPersona(); LatLng ubicacion = p.getUbicacion();
	 * 
	 * MarkerOptions markerOptions1 = MarcadorOptionsFactory.crearOpciones(
	 * Utils.EST_NUEVO, ubicacion); MarkerOptions markerOptions2 =
	 * MarcadorOptionsFactory.crearOpciones( Utils.EST_ACTUALIZADO, ubicacion);
	 * MarkerOptions markerOptions3 = MarcadorOptionsFactory.crearOpciones(
	 * Utils.EST_MODIFICADO, ubicacion); MarkerOptions markerOptions4 =
	 * MarcadorOptionsFactory.crearOpciones( "inexistente", ubicacion);
	 * 
	 * assertEquals( BitmapDescriptorFactory.defaultMarker(
	 * BitmapDescriptorFactory.HUE_AZURE), markerOptions1.getIcon()); //
